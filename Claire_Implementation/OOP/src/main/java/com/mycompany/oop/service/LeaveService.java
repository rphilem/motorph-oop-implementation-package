...
public class LeaveService {
    ...
    public Leave fileLeave(int employeeId,
        ...
        String filedDate = LocalDate.now().toString();
    ...
    // ================= APPROVAL =================
    public void approveLeave(int leaveId, String approvedBy, String remarks) {
    ...
    // ================= REJECTION =================
    public void rejectLeave(int leaveId, String approvedBy, String remarks) {
